      ...
      <main className="flex-1 flex flex-col items-center pt-24 pb-20 px-6 relative z-10">
        ...
        <div className="text-center max-w-[1200px] z-10 w-full flex flex-col lg:flex-row gap-12 items-center text-left">
          ...
          <div className="flex-1">
            ...
            <h1 className="text-[64px] md:text-[80px] font-libre-caslon-text leading-[1.1] tracking-[-0.011em] text-ink-black mb-6">
          ...
          <div className="flex-1 w-full max-w-lg">
            ...
            >
              ...
              <div className="absolute top-6 left-6 text-xs text-pure-white/80 font-mono tracking-wider uppercase flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-forest-grove animate-pulse"></span> Meridian Trace Live</div>
              <div className="space-y-4 w-full">
                <div className="bg-mist-gray text-ink-black p-4 rounded-[20px] rounded-bl-none text-[16px] leading-[1.5] w-3/4">
                  Brazil-UK Sea Corridor: Pace-X simulation complete. -34% EEOI Gap achieved.
                </div>
                <div className="bg-forest-grove text-pure-white p-4 rounded-[20px] rounded-br-none text-[16px] leading-[1.5] w-3/4 self-end ml-auto shadow-sm">
                  Locking EU ETS liability and verifying EUDR biomass via DLT.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[10px] mt-[80px] max-w-[1200px] w-full z-10">
          <div className="bg-mist-gray p-[24px] rounded-[20px] border border-ink-black/5 hover:bg-mist-gray/80 transition-colors">
            <BarChart3 className="h-8 w-8 text-forest-grove mb-4" />
            <h3 className="text-[18px] font-semibold text-ink-black mb-2">1. Measure</h3>
            <p className="text-graphite text-[14px] leading-[1.5]">Ingest AIS tracking, operational data, and cargo details to establish an irrefutable emissions baseline.</p>
          </div>
          <div className="bg-mist-gray p-[24px] rounded-[20px] border border-ink-black/5 hover:bg-mist-gray/80 transition-colors">
            <Target className="h-8 w-8 text-forest-grove mb-4" />
            <h3 className="text-[18px] font-semibold text-ink-black mb-2">2. Optimise</h3>
            <p className="text-graphite text-[14px] leading-[1.5]">Simulate maritime pathways, aviation routes, and biofuel mixtures (SAF) for immediate operational efficiency.</p>
          </div>
          <div className="bg-mist-gray p-[24px] rounded-[20px] border border-ink-black/5 hover:bg-mist-gray/80 transition-colors">
            <Calculator className="h-8 w-8 text-forest-grove mb-4" />
            <h3 className="text-[18px] font-semibold text-ink-black mb-2">3. Forecast</h3>
            <p className="text-graphite text-[14px] leading-[1.5]">Translate consumption into real-time regulatory exposure for EU ETS, FuelEU Maritime, and CORSIA frameworks.</p>
          </div>
          <div className="bg-mist-gray p-[24px] rounded-[20px] border border-ink-black/5 hover:bg-mist-gray/80 transition-colors">
            <Coins className="h-8 w-8 text-forest-grove mb-4" />
            <h3 className="text-[18px] font-semibold text-ink-black mb-2">4. Monetise</h3>
            <p className="text-graphite text-[14px] leading-[1.5]">Secure Scope 3 insetting and asset provenance on DLT, protected from double-counting and fraud.</p>
          </div>
        </div>
      </main>
    </div>
